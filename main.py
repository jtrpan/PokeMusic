...
# Updated map of each gameplay situation to its corresponding music files
music_files = {
    "Title Screen": [f"music/title{i}.wav" for i in range(1, 8)],  # updated range
    "Open World (Exploration)": [f"music/explore{i}.wav" for i in range(1, 38)],  # updated prefix and range
    "Wild Pokemon Battle": [f"music/wild{i}.wav" for i in range(1, 8)],  # updated range
    "Trainer Battle": [f"music/trainer{i}.wav" for i in range(1, 8)],  # updated range
    "Rival Battle": [f"music/rival{i}.wav" for i in range(1, 10)],  # updated range
    "Gym Leader Battle": [f"music/gym{i}.wav" for i in range(1, 8)],  # range remains the same
    "Elite Four Battle": [f"music/elite{i}.wav" for i in range(1, 7)],  # updated range
    "Champion Battle": [f"music/champ{i}.wav" for i in range(1, 8)],  # updated range
    "Grunt Battle": [f"music/grunt{i}.wav" for i in range(1, 7)],  # updated range
    "Admin Battle": [f"music/admin{i}.wav" for i in range(1, 6)],  # updated range
    "Boss Battle": [f"music/boss{i}.wav" for i in range(1, 10)],  # updated range
    "Legendary Battle": [f"music/legendary{i}.wav" for i in range(1, 7)],  # updated prefix and range
}
...
def identify(text):
    situations = {
        "Open World (Exploration)": [
            "Save your", "your game", "game with", "your progress", "A device", "device that",
            ...
            "Got away", "away safely", "to save", "save the", "the game", "Player defeated",
            "You got", "for winning!", "for winning",
        ],
        ...
        "Trainer Battle": [
            "You are challenged", "are challenged by", "challenged by",
        ],

        "Rival Battle": [
            "challenged by Rival Green!", "by Rival Green!", "by Rival Green", "by Trainer Brendan",
            "by Trainer May", "Trainer Brendan", "Trainer May",
        ],

        "Gym Leader Battle": [
            "challenged by Leader", "by Leader",
        ],

        "Elite Four Battle": [
            "challenged by Elite Four", "by Elite Four", "by Elite",
        ],

        "Champion Battle": [
            "challenged by Champion", "by Champion", "Champion Green",
        ],

        "Grunt Battle": [
            "challenged by Team Rocket Grunt!", "challenged by Team Rocket Grunt",
            "by Team Rocket Grunt", "by Team Rocket", "by Team",
        ],

        "Admin Battle": [
            "challenged by Rocket Admin", "by Rocket Admin",
        ],

        "Boss Battle": [
            "challenged by Boss Giovanni!", "by Boss Giovanni!", "challenged by Boss", "by Boss",
        ],
